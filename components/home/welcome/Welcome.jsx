  ...
  return (
    <View>
      <View style={styles.container}>
        <Text style={styles.userName}>Hello Roe</Text>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchWrapper}>
          ...
          <TouchableOpacity style={styles.searchBtn} onPress={handleClick}><Image source={icons.search} resizeMode='contain' style={styles.searchBtnImage} /></TouchableOpacity>
      </View>
